...
/// Shorten a path for display: home becomes `~`, and a long path is truncated
/// in the middle. Done here rather than with CSS `direction: rtl`, which
/// reorders the leading slash to the end and renders `/Users/x` as `Users/x/`.
